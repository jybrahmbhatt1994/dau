...
/**
 * Two-up CTA at the foot of the Academics page. Left half is `gold`
 * (Academic Calendar, dark text + navy-outline button); right half is `brand`
 * red (Course Catalogue, white text + white-outline button). Colours bleed to
 * the screen edges; content lines up with the global container.
 *
    ...
    <section id="related" className="scroll-mt-24 grid grid-cols-1 lg:grid-cols-2">
      ...
      >
        <div className="max-w-md">
          ...
          <p className="mt-5 text-base font-medium leading-relaxed text-navy/90">
      ...
      >
        <div className="max-w-md">
          ...
          <p className="mt-5 text-base font-medium leading-relaxed text-white/85">
